...
@responses.activate
def test_http_client_when_content_type_is_rss() -> None:
    expected = [{'description': 'Miami, Dubai and Singapore boom by welcoming those chased '
                                'out of rival international hubs',
                 'publishedAt': 'Sun, 12 Mar 2023 13:00:35 GMT',
                ...
                {'description': '‘Lead white knight’ eyeing British arm of tech lender that '
                 ...
                 'publishedAt': 'Sun, 12 Mar 2023 12:54:53 GMT',
